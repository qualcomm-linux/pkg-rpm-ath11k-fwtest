# Contributing to pkg-rpm-ath11k-fwtest
...
1. [Fork](https://github.com/qualcomm-linux/pkg-rpm-ath11k-fwtest/fork) and clone the repository.
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/pkg-rpm-ath11k-fwtest.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/pkg-rpm-ath11k-fwtest/pulls) from your branch to `main`.
